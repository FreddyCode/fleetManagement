		...
		<tr class="top_rw">
		   <td colspan="2">
		      <h2 align="center" style="color: #ffffff">ENSHIKA GHANA LTD</h2>
               <span><h2 style="margin-bottom: 0px;">Fleet Manager's Receipt</h2></span>
			  <span style="">  Date: {{date('F j, Y')}} </span>
		   </td>
        ...
        <td colspan="">
            <table cellspacing="0px" cellpadding="2px">
                ...
                <tr class="item">
                    ...
                    <td style="width:10%; text-align:right;">
                        <b>{{$payment[0]->total_expense}}</b>
                    </td>

                    <td style="width:10%; text-align:right;">
                     {{$payment[0]->total_expense}}
                    </td>
