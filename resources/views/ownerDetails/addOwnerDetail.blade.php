...
@section('content')
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            <form  action="{{route('postCarOwnerDetail')}}" id="frm-create-ownerdetail" method="post" enctype="multipart/form-data">
                {!!csrf_field()!!}
                @if(session('success'))
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker" data-live-search="true" name="owner_id" id="car_owner_id" data-value="{{old('owner_id')}}">
                                    ...
                                    @foreach($carowners as $key =>$c)
                                        <option value="{{$c->owner_id}}" {{ (old("owner_id") == $c->owner_id ? "selected":"")}}>{{$c->code." ".$c->first_name." "." ".$c->last_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker"  data-live-search="true" name="car" id="car_id_append" data-value="{{old('car')}}">
                                    ...
                                    @foreach($cars as $key =>$c)
                                        <option value="{{$c->car_id}}" {{ (old("car") == $c->car_id ? "selected":"")}}>{{$c->car_name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="model_id" id="model_id_append" value="{{old('model_id')}}">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="car_number" id="car_number" class="form-control" value="{{old('car_number')}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="car_color" id="car_color" class="form-control" value="{{old('car_color')}}">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_date" id="com_date" class="form-control"
                                       placeholder="click to add date" value="{{old('start_date')}}">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
...
@section('script')
    <script type="application/javascript">
        ...
        $("#frm-create-ownerdetail #car_id_append").on('change',function(e){
            var car_id = $(this).val();
