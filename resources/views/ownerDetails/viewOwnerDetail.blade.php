    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="icon_document_alt"></i><a href="/car-owners-details">Car Owners Details List</a></li>
                <li><i class="fa fa-file-text-o"></i>Car Owners Detail View</li>
            </ol>
        </div>
    </div>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker" data-live-search="true" name="owner_id" id="car_owner_id" data-value="{{old('owner_id')}}" disabled>
                                    <option value="">---------------</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control selectpicker"  data-live-search="true" name="car" id="car_id_append" data-value="{{old('car')}}" disabled>
                                    <option value="">---------------</option>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="model_id" id="model_id_append" disabled>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="car_number" id="car_number" class="form-control" value="{{$owner->car_number}}" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="car_color" id="car_color" class="form-control" value="{{$owner->car_color}}" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_date" id="com_date" class="form-control"
                                       placeholder="click to add date" value="{{$owner->start_date}}" disabled>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
