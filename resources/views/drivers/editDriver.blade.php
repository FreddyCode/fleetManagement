    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li><i class="fa fa-file-text-o"></i>Update Driver</li>
            </ol>
        </div>
    </div>
        ...
        <div class="panel-body">
            ...
            <form  method="post" action="{{route('updateDriver',$driver->id)}}" enctype="multipart/form-data">
                            ...
                            <div class="panel-body">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="first_name" id="first_name" class="form-control" value={{$driver->first_name}}>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="last_name" id="last_name" class="form-control" value={{$driver->last_name}}>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telephone" id="telephone" class="form-control" value={{$driver->telephone}}>
                                    </div>
                                </div>
                                <div class="col-md-9">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectpicker"  data-live-search="true" name="detail_id" id="detail_id">
                                            <option value="">---------------</option>
                                        ...
                                        <table style="margin: 0 auto;">
                                            ...
                                            <tr>
                                                <td class="profile-photo">
                                                    ...
                                                    <input type="file" name="image"  value="{{base64_encode($driver->image)}}" id="profile-photo" accept="image/x-png,image/png,image/jpg,image/jpeg">
                                                </td>
                                            </tr>
                                            <tr>
                                        ...
                                        <table style="margin: 0 auto;">
                                            ...
                                            <tr>
                                                <td class="identity-photo">
                                                    ...
                                                    <input type="file" name="identity"  id="identity-photo" accept="image/x-png,image/png,image/jpg,image/jpeg" value="{{$driver->identity}}">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="text-align: center;background: #ddd;">
                ...
                <div class="panel-footer">
                    <button value="submit" class="btn  btn-block">UPDATE DRIVER <i class="fa fa-save"></i> </button>
                </div>
            </form>
        </div>
    </div>
